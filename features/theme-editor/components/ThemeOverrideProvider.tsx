...
function generateOverrideCss(resolved: ResolvedTheme): string {
  ...
  lines.push(`  --heroui-warning-foreground: ${heroVar(resolved.warning.foreground)};`);
  ...
  lines.push(`  --heroui-content1-foreground: ${heroVar(resolved.foreground)};`);
  lines.push(`  --heroui-content2-foreground: ${heroVar(resolved.foreground)};`);
  lines.push(`  --heroui-content3-foreground: ${heroVar(resolved.foreground)};`);
  lines.push(`  --heroui-content4-foreground: ${heroVar(resolved.foreground)};`);
