...
export type AccessControlType = 'public' | 'whitelist' | 'nft-erc721' | 'nft-erc1155' | 'token' | 'custom';
...
export function useDeployAccessControl() {
  ...
  const deployWhitelist = useCallback(async (): Promise<`0x${string}`> => {
    ...
    const log = receipt.logs.find(
      (l) => l.topics[0] === '0xf84d091c33e25edb2fa1abb290df9814b644f5f0c29e25546983ae2577276a41',
    );
